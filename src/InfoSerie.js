                ...
                <div className='container'>
                    ...
                    <form>
                        ...
                        <div className='form-check'>
                            ...
                            <div className='form-check'>
                            <input className='form-check-input' type='radio' checked={form.status === 'PARA_ASSISTIR'} name='status' id='assistir' value='PARA_ASSISTIR' onChange={seleciona('PARA_ASSISTIR')}/>
